            ...
            <form method="POST" action="{{route('viveiros.store')}}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="width" required>
                    </div>

                    <div class="flex flex-col">
                        <label class="text-gray-700 mb-1" for="length">Comprimento</label>
                        <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="length" required>
                    </div>
                </div> 
