<x-app-layout>
    ...
    <h3 class="text-gray-700 text-3xl font-medium">Uso Diário</h3>
    <div class="mt-4 flex justify-center">
        <div class="shadow-lg w-full sm:w-1/2 rounded-lg mt-8">
            <h2 class="text-xl py-3 rounded-t-lg px-6 text-white bg-gray-800 font-bold">Adicionar Uso Diário</h2>
            <div class="p-6">
                <form method="POST" action="{{ route('uso_diario.store') }}">
                    @csrf
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="date" name="data" id="data" value="{{ old('data') }}" required>
                            @error('data')
                                <span class="text-red-600 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="number" name="quantidade_utilizada" step="0.01" value="{{ old('quantidade_utilizada') }}" required>
                        ...
                        <div class="col-span-2 flex flex-col">
                            ...
                            <textarea class="form-input w-full mt-2 rounded-md focus:border-indigo-600" name="observacoes">{{ old('observacoes') }}</textarea>
                            @error('observacoes')
                                <span class="text-red-600 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
