                ...
                <form method="POST" action="{{route('biometrias.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input class="form-input w-full mt-2 rounded-md focus:border-indigo-600" type="quantidade" name="quantidade" value="{{old('quantidade')}}" required >
                        </div>
                        <div class="flex flex-col">
                        ...
                        <div class=" col-span-2 flex flex-col">
                            ...
                            <textarea class="form-input w-full mt-2 rounded-md focus:border-indigo-600" name="observacao" {{old('observacao')}} required> {{ old('observacao') }}</textarea>
                        </div>
                    </div>
